...
**[C] Accordion: "Display toggles"** (`DisplayToggles.svelte`)
...
**[D] Accordion: "Graph info"** (`InfoBox.svelte`) — updated after each successful draw or edit.
...
**[E] Accordion: "Save / Load"** (`SaveLoad.svelte`).
...
Top-level control-panel keyboard shortcuts:

- `n` opens/closes Numerical edit.
- `g` opens/closes Edit graph on canvas.
- `s` opens/closes Save / Load.
