...
3. **Display toggles** — four toggle switches:
...
4. **Ordering direction** — segmented control: CW / CCW (default CW)

5. **Initial vertices layout** — radio group with three options for vertex placement on first draw:
    - Circle (default)
    - Grid
    - Line

6. **Predefined examples** — dropdown grouped by type; selecting loads all inputs and positions.

7. **Action buttons** — "Draw graph" (primary) and "Clear".
