...
- [x] Cyclic ordering arrows needs to be curved. For a self-loop arrow (i.e. starts from one half-edge and ends in the same half-edge), it should be drawn almost like a circle, and the cricle should goes around the associated vertex node.
